    ...
    if (!isset($_POST['csrf_token']) || !isset($_SESSION['csrf_token']) || 
        ...
        if (!$name || !$contact_name || !$phone || !$email) {
            ...
            try {
                ...
                $stmt = $pdo->prepare("SELECT supplier_id FROM suppliers WHERE email = ?");
                $stmt->execute([$email]);
                if ($stmt->fetch()) {
                ...
                // Upload logo nếu có (lưu vào thư mục, không lưu vào database vì không có cột logo)
                if (isset($_FILES['logo']) && $_FILES['logo']['error'] === UPLOAD_ERR_OK) {
                    ...
                    if (!move_uploaded_file($file['tmp_name'], $destination)) {
                        throw new Exception('Không thể tải lên file logo');
                    }
                }
                ...
                try {
                    $stmt = $pdo->prepare("
                        INSERT INTO admin_logs (
                            ...
                            note,
                            created_at
                        ) VALUES (?, 'create', 'suppliers', ?, ?, NOW())
                    ");
                    $stmt->execute([
                        $_SESSION['user_id'],
                        $supplier_id,
                        "Thêm nhà cung cấp mới: $name"
                    ]);
                } catch (Exception $e) {
            ...
            <div class="col-12 col-xl-10">
                <div class="add-card">
                    <div class="card-header-custom">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <p class="mb-0 opacity-75">Điền thông tin của nhà cung cấp mới</p>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body p-0">
                        <?php if ($error): ?>
                            <div class="alert alert-danger-modern m-3"><?= $error ?></div>
                        <?php endif; ?>
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="form-floating-modern">
                                            <textarea class="form-control form-control-modern" 
                                                      name="address" id="address" placeholder=" " rows="3"><?= htmlspecialchars($_POST['address'] ?? '') ?></textarea>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-section">
                                        ...
                                        <div class="file-upload-area" id="fileUploadArea">
                                            ...
                                            <h6>Tải lên logo nhà cung cấp</h6>
                                        ...
                                        <div id="logoPreview" class="text-center mt-3 d-none">
                                            ...
                                            <small class="text-muted mt-2 d-block">Logo đã chọn</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function resetUploadArea() {
        ...
        uploadTitle.textContent = 'Tải lên logo nhà cung cấp';
    ...
    function hideLoading() {
        ...
        submitBtn.innerHTML = '<i class="fas fa-save me-2"></i>Lưu nhà cung cấp';
    }
    ...
    function saveFormData() {
        ...
        localStorage.setItem('supplier_add_form', JSON.stringify(data));
    }

    function loadFormData() {
        const savedData = localStorage.getItem('supplier_add_form');
        if (savedData) {
    ...
    form.addEventListener('submit', function() {
        localStorage.removeItem('supplier_add_form');
    });
    ...
    setTimeout(() => {
        ...
        if (addCard) {
            addCard.style.opacity = '0.8';
            setTimeout(() => {
                addCard.style.transition = 'all 0.5s ease';
                addCard.style.opacity = '1';
                addCard.style.transform = 'translateY(-10px)';
                setTimeout(() => {
